...
|-----------|------------|----------|
| Active Display | 640 C.C. | 480 C.C.|
| Front Porch | 16 C.C. | 10 C.C. |
| Sync Pulse | 96 C.C. | 2 C.C. |
| Back Porch | 48 C.C. | 33 C.C.|
| Total | 800 | 525 |
